import com.tw.*;
import com.tw.chooser.SmartParkingLotChooser;
...
public class SmartParkerTest {
    ...
    public void setUp() throws Exception {
        ...
        parker = new CompositeParker(parkables, new SmartParkingLotChooser());
        car = new Car();
    }
    ...
    public void should_park_the_car_in_the_second_parking_lot() {
        ...
        assertThat(parkingLot1.getRemainingCarports(), is(1));
        assertThat(parkingLot2.getRemainingCarports(), is(1));
    }

    @Test
    public void should_park_the_car_in_the_first_parking_lot_if_the_remaining_carports_in_two_parking_lots_are_the_same() {
    ...
    public void should_park_the_car_in_the_first_parking_lot() {
        ...
        assertThat(parkingLot1.getRemainingCarports(), is(1));
        assertThat(parkingLot2.getRemainingCarports(), is(2));
    }
